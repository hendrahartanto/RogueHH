...
public class FindPathActionSO : StateActionSO
{
  ...
  [SerializeField] private TransformAnchorSO playerTransform; //untuk posisi player sekarang / startNode
  ...
  public override void InitComponent(StateMachine stateMachine)
  {
    ...
    _pathStorage = player.PathStorage;
  ...
  public override void OnStateEnter()
  {
    ...
    Node startNode = _gridNode[(int)playerTransform.Value.position.x / GridConfig.CellSize.x, (int)playerTransform.Value.position.z / GridConfig.CellSize.z];
